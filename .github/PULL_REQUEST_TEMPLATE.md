...
- [ ] This PR includes a new checks or changes the configuration of a check
  ...
  - [ ] I ran `yarn build` and committed the updated configuration files
    <!-- It might be that a check doesn't make sense in certain contexts -->
    <!-- When that happens, the check's config should be updated/overridden in the appropriate config -->
  - [ ] I've made a PR to update the [platformOS documentation](https://documentation.platformos.com/developer-guide/platformos-check/platformos-check) if applicable (link PR here).
