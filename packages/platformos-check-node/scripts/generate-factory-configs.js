...
const {
  ...
  SourceCodeType,
  recommended,
} = require('@platformos/platformos-check-common');
...
async function run() {
  ...
  // Note: theme-app-extension.yml was removed as it's Shopify-specific
  // App block checks are still available but without a dedicated config file
}
