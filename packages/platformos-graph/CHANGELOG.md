# shopify/platformos-graph

## 0.2.1

### Patch Changes

- Patch bump because it depends on @platformos/platformos-check-common
...
- 4477a6d9: Introduce `@platformos/platformos-graph`, a data structure that represents all the modules in a Shopify theme
