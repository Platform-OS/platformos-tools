...
- [`@platformos/platformos-language-server-common`](../theme-language-server-common) — (you are here) Runtime agnostic [Language Server](https://microsoft.github.io/language-server-protocol/) that can run in browser or Node.js.  
- [`@platformos/platformos-language-server-browser`](../browser) — Browser specific wrapper over the common library.  
- [`@platformos/platformos-language-server-node`](../node) — Node.js specific wrapper over the common library.  
