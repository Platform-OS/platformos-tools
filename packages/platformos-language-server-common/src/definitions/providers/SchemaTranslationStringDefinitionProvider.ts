import { LiquidHtmlNode, LiquidRawTag, NodeTypes } from '@platformos/liquid-html-parser';
import { SourceCodeType, findJSONNode, nodeAtPath } from '@platformos/platformos-check-common';
import {
  DefinitionLink,
  DefinitionParams,
  LocationLink,
