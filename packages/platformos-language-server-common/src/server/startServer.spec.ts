...
describe('Module: server', () => {
  ...
  it('go-to-definition reflects updated search paths after saving app/config.yml', async () => {
    ...
    const result1 = await connection.triggerRequest(DefinitionRequest.method, params);
    ...
    const result2 = await connection.triggerRequest(DefinitionRequest.method, params);
