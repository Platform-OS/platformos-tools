...
(TASK-12.5): the only thing it could select was the linter's whole-project check
partition, and that went away with `OrphanedPartial` (TASK-29). Every check answers
